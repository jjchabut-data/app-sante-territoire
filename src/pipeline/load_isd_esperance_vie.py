...
Chargement du fichier ISD C04 - Espérance de vie (4 millésimes).
...
Usage :
    python load_isd_esperance_vie.py --mode local
    python load_isd_esperance_vie.py --mode cloud
    python load_isd_esperance_vie.py --mode cloud --annee 2023
"""
...
# Config
# ---------------------------------------------------------------------------
FILE_PATH  = Path("../../data/raw/source/C04-ISD_Esperance_de_vie.xlsx")
SKIPROWS   = 5
...
RENAME_MAP = {
    ...
    "Hommes":     "esp_vie_hommes",
    "Femmes":     "esp_vie_femmes",
    "Hommes.1":   "esp_vie_hommes_a_60a",
    "Femmes.1":   "esp_vie_femmes_a_60a",
    "Hommes.2":   "esp_vie_hommes_a_65a",
    "Femmes.2":   "esp_vie_femmes_a_65a",
}
...
def export_local(df: pd.DataFrame, annee: int) -> None:
    ...
    output_path = OUTPUT_DIR / f"isd_c04_esperance_vie_{annee}.parquet"
...
def upload_to_bigquery(df: pd.DataFrame, annee: int) -> None:
    ...
    destination = f"raw.isd_c04_esperance_vie_{annee}"
