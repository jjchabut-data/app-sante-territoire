"""
load_isd_mortalite.py
Chargement du fichier ISD C03 - Taux de mortalité.
...
Usage :
    python load_isd_mortalite.py --mode local
    python load_isd_mortalite.py --mode cloud
"""
...
# Config
# ---------------------------------------------------------------------------
FILE_PATH       = Path("../data/raw/source/C03-ISD_Taux_de_mortalite.xlsx")
SHEET_NAME      = "DEP"
SKIPROWS        = 5
OUTPUT_DIR      = Path("../data/source/extracted")
OUTPUT_FILE     = "isd_c03_tx_mortalite_2024.parquet"

PROJECT_ID      = "app-territoire"
DESTINATION     = "raw.isd_c03_tx_mortalite_2024"
IF_EXISTS       = "replace"

RENAME_MAP = {
    "Unnamed: 0": "code_departement",
    "Département": "nom_departement",
    "Taux brut de mortalité en 2024 (en ‰)":  "tx_mortalite_brut",
    "Taux brut de mortalité des femmes en 2024 (en ‰)": "tx_mortalite_brut_femmes",
    "Taux brut de mortalité des hommes en 2024 (en ‰)": "tx_mortalite_brut_hommes",
    "Taux de mortalité standard. des 0-64 ans en 2024 (prématuré) (en ‰)":"tx_mortalite_std_0_64",
    "Taux de mortalité standard. des 65 ans ou plus en 2024 (en ‰)":  "tx_mortalite_std_65_plus",
    "Taux de mortalité infantile (pour 1000 enfants nés vivants entre 2022 et 2024) (en ‰)":"tx_mortalite_infantile",
    "Nombre de décès domiciliés en 2024":  "nb_deces_domicilies",
}
