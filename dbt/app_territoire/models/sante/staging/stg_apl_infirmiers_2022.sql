-- stg_apl_infirmiers_2022.sql
with source as (
    select * from {{ source('raw', 'apl_infirmiers_2022') }}
),
...
renamed as (
    select
        ...
        cast(`Population standardisée 2020 pour les infirmières`   as float64) as population_std,
